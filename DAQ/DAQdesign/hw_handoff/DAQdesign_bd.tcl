...
################################################################
# This is a generated script based on design: DAQdesign
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net KSAddSubb_11_sum [get_bd_pins KSAddSubb_11/sum] [get_bd_pins xlconcat_11/In0]
  connect_bd_net -net KSAddSubb_12_cout [get_bd_pins KSAddSubb_12/cout] [get_bd_pins xlconcat_12/In1]
  connect_bd_net -net KSAddSubb_12_sum [get_bd_pins KSAddSubb_12/sum] [get_bd_pins xlconcat_12/In0]
  connect_bd_net -net KSAddSubb_13_cout [get_bd_pins KSAddSubb_13/cout] [get_bd_pins xlconcat_13/In1]
  connect_bd_net -net KSAddSubb_13_sum [get_bd_pins KSAddSubb_13/sum] [get_bd_pins xlconcat_13/In0]
  connect_bd_net -net KSAddSubb_14_cout [get_bd_pins KSAddSubb_14/cout] [get_bd_pins xlconcat_14/In1]
  connect_bd_net -net KSAddSubb_14_sum [get_bd_pins KSAddSubb_14/sum] [get_bd_pins xlconcat_14/In0]
  connect_bd_net -net KSAddSubb_15_cout [get_bd_pins KSAddSubb_15/cout] [get_bd_pins xlconcat_15/In1]
  connect_bd_net -net KSAddSubb_15_sum [get_bd_pins KSAddSubb_15/sum] [get_bd_pins xlconcat_15/In0]
  connect_bd_net -net KSAddSubb_16_cout [get_bd_pins KSAddSubb_16/cout] [get_bd_pins xlconcat_16/In1]
  connect_bd_net -net KSAddSubb_16_sum [get_bd_pins KSAddSubb_16/sum] [get_bd_pins xlconcat_16/In0]
  connect_bd_net -net KSAddSubb_17_cout [get_bd_pins KSAddSubb_17/cout] [get_bd_pins xlconcat_17/In1]
  connect_bd_net -net KSAddSubb_17_sum [get_bd_pins KSAddSubb_17/sum] [get_bd_pins xlconcat_17/In0]
  connect_bd_net -net KSAddSubb_18_cout [get_bd_pins KSAddSubb_18/cout] [get_bd_pins xlconcat_18/In1]
  ...
  connect_bd_net -net KSAddSubb_21_sum [get_bd_pins KSAddSubb_21/sum] [get_bd_pins xlconcat_21/In0]
  connect_bd_net -net KSAddSubb_22_cout [get_bd_pins KSAddSubb_22/cout] [get_bd_pins xlconcat_22/In1]
  connect_bd_net -net KSAddSubb_22_sum [get_bd_pins KSAddSubb_22/sum] [get_bd_pins xlconcat_22/In0]
  connect_bd_net -net KSAddSubb_23_cout [get_bd_pins KSAddSubb_23/cout] [get_bd_pins xlconcat_23/In1]
  connect_bd_net -net KSAddSubb_23_sum [get_bd_pins KSAddSubb_23/sum] [get_bd_pins xlconcat_23/In0]
  connect_bd_net -net KSAddSubb_24_cout [get_bd_pins KSAddSubb_24/cout] [get_bd_pins xlconcat_24/In1]
  connect_bd_net -net KSAddSubb_24_sum [get_bd_pins KSAddSubb_24/sum] [get_bd_pins xlconcat_24/In0]
  connect_bd_net -net KSAddSubb_25_cout [get_bd_pins KSAddSubb_25/cout] [get_bd_pins xlconcat_25/In1]
  connect_bd_net -net KSAddSubb_25_sum [get_bd_pins KSAddSubb_25/sum] [get_bd_pins xlconcat_25/In0]
  connect_bd_net -net KSAddSubb_26_cout [get_bd_pins KSAddSubb_26/cout] [get_bd_pins xlconcat_26/In1]
  ...
  connect_bd_net -net KSAddSubb_5_sum [get_bd_pins KSAddSubb_5/sum] [get_bd_pins xlconcat_5/In0]
  connect_bd_net -net KSAddSubb_6_cout [get_bd_pins KSAddSubb_6/cout] [get_bd_pins xlconcat_6/In1]
  connect_bd_net -net KSAddSubb_6_sum [get_bd_pins KSAddSubb_6/sum] [get_bd_pins xlconcat_6/In0]
  connect_bd_net -net KSAddSubb_7_cout [get_bd_pins KSAddSubb_7/cout] [get_bd_pins xlconcat_7/In1]
  connect_bd_net -net KSAddSubb_7_sum [get_bd_pins KSAddSubb_7/sum] [get_bd_pins xlconcat_7/In0]
  connect_bd_net -net KSAddSubb_8_cout [get_bd_pins KSAddSubb_8/cout] [get_bd_pins xlconcat_8/In1]
